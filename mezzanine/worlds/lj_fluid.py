...
@ADAPTERS.register("lj_fluid_h5", description="Load an LJ fluid/droplet snapshot dataset from HDF5 (generated by examples/lj_generate_dataset.py).")
class LJFluidH5Adapter(WorldAdapter):
    ...
    def load(self) -> Dict[str, Any]:
        ...
        def build_examples(arrs: Dict[str, np.ndarray], *, n_target: int, split_seed: int) -> List[Dict[str, Any]]:
        ...
        train = build_examples(tr, n_target=int(self.cfg.n_train), split_seed=int(self.cfg.seed) + 17)
        test = build_examples(te, n_target=int(self.cfg.n_test), split_seed=int(self.cfg.seed) + 19)
